...
"""
@cenum AVOptionType::UInt32 begin
    AV_OPT_TYPE_FLAGS = 0
    AV_OPT_TYPE_INT = 1
    AV_OPT_TYPE_INT64 = 2
...
@cenum AVClassCategory::UInt32 begin
...
"""
@cenum AVAppToDevMessageType::UInt32 begin
...
"""
@cenum AVDevToAppMessageType::UInt32 begin
...
"""
@cenum AVIODataMarkerType::UInt32 begin
...
"""
@cenum AVDurationEstimationMethod::UInt32 begin
...
@cenum AVTimebaseSource::Int32 begin
    AVFMT_TBCF_AUTO = -1
...
"""
@cenum AVIODirEntryType::UInt32 begin
...
@cenum AVEscapeMode::UInt32 begin
...
@cenum AVMatrixEncoding::UInt32 begin
...
"""
@cenum AVDownmixType::UInt32 begin
...
@cenum AVFilmGrainParamsType::UInt32 begin
...
@cenum AVActiveFormatDescription::UInt32 begin
    AV_AFD_SAME = 8
    AV_AFD_4_3 = 9
    AV_AFD_16_9 = 10
    AV_AFD_14_9 = 11
...
"""
@cenum AVHDRPlusOverlapProcessOption::UInt32 begin
...
@cenum AVHWFrameTransferDirection::UInt32 begin
...
@cenum __JL_Ctag_828::UInt32 begin
    ...
    AV_VAAPI_DRIVER_QUIRK_SURFACE_ATTRIBUTES = 8
end
...
"""
@cenum AVSphericalProjection::UInt32 begin
...
"""
@cenum AVStereo3DType::UInt32 begin
    AV_STEREO3D_2D = 0
...
"""
@cenum AVStereo3DView::UInt32 begin
...
@cenum AVThreadMessageFlags::UInt32 begin
...
@cenum AVTimecodeFlag::UInt32 begin
...
@cenum AVVideoEncParamsType::Int32 begin
