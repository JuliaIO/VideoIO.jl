...
function av_stream_get_recommended_encoder_configuration(s)
    ccall((:av_stream_get_recommended_encoder_configuration,libavformat),Ptr{UInt8},(Ptr{AVStream},),s)
end

function av_stream_set_recommended_encoder_configuration(s,configuration)
    ccall((:av_stream_set_recommended_encoder_configuration,libavformat),Void,(Ptr{AVStream},Ptr{UInt8}),s,configuration)
end
...
function av_format_set_data_codec(s,c)
    ccall((:av_format_set_data_codec,libavformat),Void,(Ptr{AVFormatContext},Ptr{AVCodec}),s,c)
end
...
function av_format_set_open_cb(s,callback::AVOpenCallback)
    ccall((:av_format_set_open_cb,libavformat),Void,(Ptr{AVFormatContext},AVOpenCallback),s,callback)
end
...
function av_probe_input_buffer2(pb,fmt,url,logctx,offset::Integer,max_probe_size::Integer)
    ccall((:av_probe_input_buffer2,libavformat),Cint,(Ptr{AVIOContext},Ptr{Ptr{AVInputFormat}},Ptr{UInt8},Ptr{Void},UInt32,UInt32),pb,fmt,url,logctx,offset,max_probe_size)
end

function av_probe_input_buffer(pb,fmt,url,logctx,offset::Integer,max_probe_size::Integer)
    ccall((:av_probe_input_buffer,libavformat),Cint,(Ptr{AVIOContext},Ptr{Ptr{AVInputFormat}},Ptr{UInt8},Ptr{Void},UInt32,UInt32),pb,fmt,url,logctx,offset,max_probe_size)
end

function avformat_open_input(ps,url,fmt,options)
    ccall((:avformat_open_input,libavformat),Cint,(Ptr{Ptr{AVFormatContext}},Ptr{UInt8},Ptr{AVInputFormat},Ptr{Ptr{AVDictionary}}),ps,url,fmt,options)
end
...
function av_program_add_stream_index(ac,progid::Integer,idx::Integer)
    ccall((:av_program_add_stream_index,libavformat),Void,(Ptr{AVFormatContext},Cint,UInt32),ac,progid,idx)
end
