...
function av_dict_set_int(pm,key,value::Int64,flags::Integer)
    ccall((:av_dict_set_int,libavutil),Cint,(Ref{Ptr{AVDictionary}},Ptr{UInt8},Int64,Cint),pm,key,value,flags)
end

function av_dict_parse_string(pm,str,key_val_sep,pairs_sep,flags::Integer)
    ccall((:av_dict_parse_string,libavutil),Cint,(Ref{Ptr{AVDictionary}},Ptr{UInt8},Ptr{UInt8},Ptr{UInt8},Cint),pm,str,key_val_sep,pairs_sep,flags)
end
