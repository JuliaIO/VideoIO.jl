# Julia wrapper for header: /usr/local/ffmpeg/2.4/include/libavutil/file.h
...
function av_tempfile(prefix,filename,log_offset::Integer,log_ctx)
    ccall((:av_tempfile,libavutil),Cint,(Ptr{UInt8},Ptr{Ptr{UInt8}},Cint,Ptr{Cvoid}),prefix,filename,log_offset,log_ctx)
end
