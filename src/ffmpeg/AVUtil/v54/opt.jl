...
function av_opt_set_dict_val(obj,name,val,search_flags::Integer)
    ccall((:av_opt_set_dict_val,libavutil),Cint,(Ptr{Void},Ptr{UInt8},Ptr{AVDictionary},Cint),obj,name,val,search_flags)
end
...
function av_opt_get_dict_val(obj,name,search_flags::Integer,out_val)
    ccall((:av_opt_get_dict_val,libavutil),Cint,(Ptr{Void},Ptr{UInt8},Cint,Ptr{Ptr{AVDictionary}}),obj,name,search_flags,out_val)
end
