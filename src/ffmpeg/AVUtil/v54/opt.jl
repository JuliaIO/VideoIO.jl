# Julia wrapper for header: /usr/local/ffmpeg/2.4/include/libavutil/opt.h
...
function av_opt_set_from_string(ctx,opts,shorthand,key_val_sep,pairs_sep)
    ccall((:av_opt_set_from_string,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},Ptr{Ptr{UInt8}},Ptr{UInt8},Ptr{UInt8}),ctx,opts,shorthand,key_val_sep,pairs_sep)
end
...
function av_opt_set_bin(obj,name,val,size::Integer,search_flags::Integer)
    ccall((:av_opt_set_bin,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},Ptr{UInt8},Cint,Cint),obj,name,val,size,search_flags)
end

function av_opt_set_image_size(obj,name,w::Integer,h::Integer,search_flags::Integer)
    ccall((:av_opt_set_image_size,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},Cint,Cint,Cint),obj,name,w,h,search_flags)
end

function av_opt_set_pixel_fmt(obj,name,fmt::AVPixelFormat,search_flags::Integer)
    ccall((:av_opt_set_pixel_fmt,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},AVPixelFormat,Cint),obj,name,fmt,search_flags)
end

function av_opt_set_sample_fmt(obj,name,fmt::AVSampleFormat,search_flags::Integer)
    ccall((:av_opt_set_sample_fmt,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},AVSampleFormat,Cint),obj,name,fmt,search_flags)
end

function av_opt_set_video_rate(obj,name,val::AVRational,search_flags::Integer)
    ccall((:av_opt_set_video_rate,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},AVRational,Cint),obj,name,val,search_flags)
end

function av_opt_set_channel_layout(obj,name,ch_layout::Int64,search_flags::Integer)
    ccall((:av_opt_set_channel_layout,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},Int64,Cint),obj,name,ch_layout,search_flags)
end

function av_opt_set_dict_val(obj,name,val,search_flags::Integer)
    ccall((:av_opt_set_dict_val,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},Ptr{AVDictionary},Cint),obj,name,val,search_flags)
end
...
function av_opt_get_image_size(obj,name,search_flags::Integer,w_out,h_out)
    ccall((:av_opt_get_image_size,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},Cint,Ptr{Cint},Ptr{Cint}),obj,name,search_flags,w_out,h_out)
end

function av_opt_get_pixel_fmt(obj,name,search_flags::Integer,out_fmt)
    ccall((:av_opt_get_pixel_fmt,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},Cint,Ptr{AVPixelFormat}),obj,name,search_flags,out_fmt)
end

function av_opt_get_sample_fmt(obj,name,search_flags::Integer,out_fmt)
    ccall((:av_opt_get_sample_fmt,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},Cint,Ptr{AVSampleFormat}),obj,name,search_flags,out_fmt)
end

function av_opt_get_video_rate(obj,name,search_flags::Integer,out_val)
    ccall((:av_opt_get_video_rate,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},Cint,Ptr{AVRational}),obj,name,search_flags,out_val)
end

function av_opt_get_channel_layout(obj,name,search_flags::Integer,ch_layout)
    ccall((:av_opt_get_channel_layout,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},Cint,Ptr{Int64}),obj,name,search_flags,ch_layout)
end

function av_opt_get_dict_val(obj,name,search_flags::Integer,out_val)
    ccall((:av_opt_get_dict_val,libavutil),Cint,(Ptr{Cvoid},Ptr{UInt8},Cint,Ptr{Ptr{AVDictionary}}),obj,name,search_flags,out_val)
end

function av_opt_ptr(avclass,obj,name)
    ccall((:av_opt_ptr,libavutil),Ptr{Cvoid},(Ptr{AVClass},Ptr{Cvoid},Ptr{UInt8}),avclass,obj,name)
end
...
function av_opt_query_ranges(arg1,obj,key,flags::Integer)
    ccall((:av_opt_query_ranges,libavutil),Cint,(Ptr{Ptr{AVOptionRanges}},Ptr{Cvoid},Ptr{UInt8},Cint),arg1,obj,key,flags)
end
...
function av_opt_query_ranges_default(arg1,obj,key,flags::Integer)
    ccall((:av_opt_query_ranges_default,libavutil),Cint,(Ptr{Ptr{AVOptionRanges}},Ptr{Cvoid},Ptr{UInt8},Cint),arg1,obj,key,flags)
end
