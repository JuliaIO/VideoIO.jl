...
function av_image_fill_linesizes(linesizes::NTuple{4, Cint}, pix_fmt::AVPixelFormat, width::Integer)
    ccall((:av_image_fill_linesizes, libavutil), Cint, (NTuple{4, Cint}, AVPixelFormat, Cint), linesizes, pix_fmt, width)
end

function av_image_fill_pointers(data::NTuple{4, Ptr{UInt8}}, pix_fmt::AVPixelFormat, height::Integer, ptr, linesizes::NTuple{4, Cint})
    ccall((:av_image_fill_pointers, libavutil), Cint, (NTuple{4, Ptr{UInt8}}, AVPixelFormat, Cint, Ptr{UInt8}, NTuple{4, Cint}), data, pix_fmt, height, ptr, linesizes)
end

function av_image_alloc(pointers::NTuple{4, Ptr{UInt8}}, linesizes::NTuple{4, Cint}, w::Integer, h::Integer, pix_fmt::AVPixelFormat, align::Integer)
    ccall((:av_image_alloc, libavutil), Cint, (NTuple{4, Ptr{UInt8}}, NTuple{4, Cint}, Cint, Cint, AVPixelFormat, Cint), pointers, linesizes, w, h, pix_fmt, align)
end
...
function av_image_copy_uc_from(dst_data::NTuple{4, Ptr{UInt8}}, dst_linesizes::NTuple{4, Cptrdiff_t}, src_data::NTuple{4, Ptr{UInt8}}, src_linesizes::NTuple{4, Cptrdiff_t}, pix_fmt::AVPixelFormat, width::Integer, height::Integer)
...
function av_image_check_size2(w::Integer, h::Integer, max_pixels::Int64, pix_fmt::AVPixelFormat, log_offset::Integer, log_ctx)
    ccall((:av_image_check_size2, libavutil), Cint, (UInt32, UInt32, Int64, AVPixelFormat, Cint, Ptr{Cvoid}), w, h, max_pixels, pix_fmt, log_offset, log_ctx)
end
...
function av_image_fill_black(dst_data::NTuple{4, Ptr{UInt8}}, dst_linesize::NTuple{4, Cptrdiff_t}, pix_fmt::AVPixelFormat, range::AVColorRange, width::Integer, height::Integer)
    ccall((:av_image_fill_black, libavutil), Cint, (NTuple{4, Ptr{UInt8}}, NTuple{4, Cptrdiff_t}, AVPixelFormat, AVColorRange, Cint, Cint), dst_data, dst_linesize, pix_fmt, range, width, height)
end
