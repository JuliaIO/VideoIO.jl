# Julia wrapper for header: /usr/local/include/libavutil/timecode.h
...
function av_timecode_init_from_string(tc,rate::AVRational,str,log_ctx)
    ccall((:av_timecode_init_from_string,libavutil),Cint,(Ptr{AVTimecode},AVRational,Cstring,Ptr{Void}),tc,rate,str,log_ctx)
end
