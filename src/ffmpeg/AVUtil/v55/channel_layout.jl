# Julia wrapper for header: /usr/local/include/libavutil/channel_layout.h
...
function av_get_standard_channel_layout(index::Integer,layout,name)
    ccall((:av_get_standard_channel_layout,libavutil),Cint,(UInt32,Ptr{UInt64},Ptr{Cstring}),index,layout,name)
end
